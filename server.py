...
[GHOST IN SHELL — AUTO-EXPLOITATION]
  ghost_exploit_library()              List all available exploit modules
  ghost_build_target_profile(...)      Build target JSON from simple params
  ghost_auto_exploit(target_json, ...) Run autonomous exploit chain
  ghost_session_status(session_id)     Check active session status
  ghost_active_sessions()              List all active sessions
